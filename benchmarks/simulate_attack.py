...
def run():
    ...
    # 1. Baseline
    nonce1 = get_nonce()
    headers1, _ = simulator.sign_request("GET", "127.0.0.1:8001", "/api/v1/resource", body=b"", nonce=nonce1)
    ...
    nonce4 = get_nonce()
    headers_valid, _ = simulator.sign_request("POST", "127.0.0.1:8001", "/api/v1/resource", query="", body=valid_body, nonce=nonce4)
    ...
    nonce4b = get_nonce()
    headers_advanced_valid, _ = simulator.sign_request("POST", "127.0.0.1:8001", "/api/v1/resource", query="", body=valid_body, nonce=nonce4b)
    ...
    # 5. Path 변조
    nonce5 = get_nonce()
    headers_path, _ = simulator.sign_request("GET", "127.0.0.1:8001", "/api/v1/resource", body=b"", nonce=nonce5)
